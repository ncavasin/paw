...
<html lang="es-AR">
    <head>
        ...
        <link rel="stylesheet" href="../views/styles/reset.css"/>
        <link rel="stylesheet" href="../views/styles/icono.min.css">  
        <link rel="stylesheet" href="../views/styles/header_footer.css"/>
        <link rel="stylesheet" href="../views/styles/main.css"/>
        <link rel="stylesheet" href="../views/styles/form.css"/>
        <link rel="stylesheet" href="../views/styles/turnos.css"/>
